...
public class WeighingBillApi {
    ...
    public @ResponseBody
    BaseOutput insert(@RequestBody WeighingBill weighingBill, HttpServletRequest request) {
        try {
    ...
    public @ResponseBody
    BaseOutput update(@RequestBody WeighingBill weighingBill, HttpServletRequest request) {
        try {
            LoggerContext.put(LoggerConstant.LOG_REMOTE_IP_KEY, WebUtil.getClientIP(request));
    ...
    public @ResponseBody
    BaseOutput settle(@RequestParam Long id, @RequestParam String buyerPassword, @RequestParam Long operatorId, @RequestParam Long marketId, HttpServletRequest request) {
        try {
            LoggerContext.put(LoggerConstant.LOG_REMOTE_IP_KEY, WebUtil.getClientIP(request));
    ...
    public BaseOutput<Object> sourceSync() {
        return this.weighingBillService.sourceSync();
    }
}
