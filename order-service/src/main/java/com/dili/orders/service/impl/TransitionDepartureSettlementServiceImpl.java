...
//        }
        ...
        //设置余额
        transitionDepartureSettlement.setCustomerBalance(String.valueOf(Long.valueOf(accountFund.getBalance() - transitionDepartureSettlement.getChargeAmount()).doubleValue() / 100));
        //设置为已支付状态
