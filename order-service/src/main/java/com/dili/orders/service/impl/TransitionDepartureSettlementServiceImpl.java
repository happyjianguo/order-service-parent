...
//        transitionDepartureApply.setPayStatus(2);
        ...
        vehicleAccessDTO.setCustomerType(transitionDepartureSettlement.getCustomerMarketType());
        vehicleAccessDTO.setCustomerTypeCode(transitionDepartureSettlement.getCustomerMarketTypeCN());
        //判断进门收费新增是否成功
