...
public class SerialRecordDo implements Serializable {
	...
	public String toString() {
		return "SerialRecordEntity{" + "id='" + id + '\'' + ", serialNo='" + serialNo + '\'' + ", accountId='" + accountId + '\'' + ", cardNo='" + cardNo + '\'' + ", customerId='" + customerId + '\''
				+ ", customerNo='" + customerNo + '\'' + ", customerName='" + customerName + '\'' + ", action='" + action + '\'' + ", startBalance='" + startBalance + '\'' + ", amount='" + amount
				+ '\'' + ", endBalance='" + endBalance + '\'' + ", tradeType='" + tradeType + '\'' + ", tradeChannel='" + tradeChannel + '\'' + ", tradeNo='" + tradeNo + '\'' + ", fundItem='"
				+ fundItem + '\'' + ", fundItemName='" + fundItemName + '\'' + ", operatorId='" + operatorId + '\'' + ", operatorNo='" + operatorNo + '\'' + ", operatorName='" + operatorName + '\''
				+ ", operateTime='" + operateTime + '\'' + ", notes='" + notes + '\'' + ", firmId='" + firmId + '\'' + '}';
	}
